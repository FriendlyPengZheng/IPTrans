...
public class TestMain3 {
	...
	public static SimpleDataSource simpleDS = new SimpleDataSource();
	...
	public static void readFile(){
		...
		try {
			...
			while((line = bufferedReader.readLine()) != null){
				...
				startIp = items[7];
				endIp = items[8];
                String code2 = simpleDS.selectCode2(country);
			...
			writeFile(sbCoutry.toString(),new File("E:\\UnKnown1"));
